...
TEST(ParallelMatrix, set){
  ...
  std::vector<std::vector<double>> vals = {{1.1, 2.3, 3.1, 0.042, 5.1, 0.027},
                                           {6.3, 8.2, 3.6, 4.3, 0.052, 0.052},
                                           {0.042, 5.1, 6.3, 0.042, 0.032, 6.3},
                                           {3.6, 4.3, 0.052, 2.3, 3.1, 0.042},
                                           {0.027, 0.032, 2.3, 3.1, 0.042, 5.1},
                                           {0.032, 6.3, 8.2, 3.6, 4.3, 0.052}};
